...
This repo is setup to pull the most recent version of [`clap`](https://github.com/free-audio/clap) every week. If it's a published version newer than `TRACKED_VERSION`, we pull the version content, generated odin bindings with [`odin-c-bindgen`](https://github.com/karl-zylinski/odin-c-bindgen) and open a pull request.
