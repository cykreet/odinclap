...
3. The footer files are copied next to the source header files, `odin-c-bindgen` finds these and inserts their content near the bottom of the generated odin file.
